...
public class RedisApi {
    ...
    static {
        InputStream in = RedisApi.class.getClassLoader()
                .getResourceAsStream("/first-app-dal/src/test/resources/redis.properties");
      //文件在class的根路径  
        InputStream is=RedisApi.class.getClassLoader().getResourceAsStream("redis.properties");  
        //获取文件的位置  
        String filePath=RedisApi.class.getClassLoader().getResource("redis.properties").getFile();  
